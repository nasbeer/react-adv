...
var FDateTimePicker = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(FDateTimePicker, _React$PureComponent);

  var _super = _createSuper(FDateTimePicker);
  ...
  _createClass(FDateTimePicker, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_pickers.DateTimePicker, _extends({
        label: label,
        error: hasError,
